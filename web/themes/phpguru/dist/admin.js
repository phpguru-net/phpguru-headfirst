...
$(function () {
  M.AutoInit(); // open sidenav

  const sideNavInstance = M.Sidenav.getInstance($(".sidenav"));
  sideNavInstance.open(); // collapsible
